...
public:
    ...
    torch::Tensor getProjectionMatrix2(
        float znear,
        float zfar,
        float cx,
        float cy,
...
public:
    ...
    torch::Tensor original_image_, depth_image_; ///< image
    ...
    // Depth Image
    std::vector<torch::Tensor> gaus_pyramid_depth_image_;    ///< gaus_pyramid depth image
