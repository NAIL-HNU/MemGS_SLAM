...
GaussianRasterizerFunction::forward(
    ...
    // bool prefiltered)
{
    // Invoke C++/CUDA rasterizer in (rasterize_points.h and *.cu)
    ...
    torch::autograd::tensor_list grad_outputs)
{
    ...
    // auto grad_out_opacity = grad_outputs[3];
    // auto grad_out_n_touched = grad_outputs[4];
    // Invoke C++/CUDA rasterizer in (rasterize_points.h and *.cu)
...
std::tuple<torch::Tensor/* rgb */, torch::Tensor/* radii */, torch::Tensor/* depth */, torch::Tensor/* opacity */, torch::Tensor/* n_touched */>
...

{
    ...
    // 内部调用GaussianRasterizerFunction::apply
    ...
    return std::make_tuple(result[0]/*color*/, result[1]/*radii*/, result[2]/*depth*/,
                           result[3]/*opacity*/, result[4]/*n_touched*/);
}