...
std::tuple<int/* num_rendered */, torch::Tensor/* color */, torch::Tensor/* radii */, torch::Tensor/* geomBuffer */, torch::Tensor/* binningBuffer */, torch::Tensor/* imgBuffer */, torch::Tensor/* depth */, torch::Tensor/* opacity */, torch::Tensor/* n_touched */>
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
 RasterizeGaussiansBackwardCUDA(
	...
	const torch::Tensor& dL_dout_depths,  /* grad_out_depth */
	const torch::Tensor& sh,
	const int degree,
	const torch::Tensor& campos,
	...
	const torch::Tensor& imageBuffer) 
{
  ...
  {  
	  ...
	  dL_dout_depths.contiguous().data_ptr<float>(),  /* grad_out_depth */
