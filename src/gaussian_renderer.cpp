 ...
 */
std::tuple<torch::Tensor/* rgb */, torch::Tensor/*viewspace_points */, torch::Tensor/* visibility_filter */, torch::Tensor/* radii */, torch::Tensor/* depth */, torch::Tensor/* opacity */, torch::Tensor/* n_touched */>
